...
@section('title', 'Nuevo Bastón')

@section('content_header')
    <h1><i class="fas fa-plus-circle text-primary mr-2"></i>Nuevo Bastón</h1>
@stop

@section('content')
    <div class="card card-outline card-primary">
        <div class="card-header">
            <h3 class="card-title"><i class="fas fa-walking mr-1"></i> Datos del Bastón</h3>
        </div>
        <form action="{{ route('bastones.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="codigo" required maxlength="50"
                                   ...
                                   value="{{ old('codigo') }}" placeholder="Ej: BST-001">
                            @error('codigo')
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="modelo" required maxlength="100"
                                   ...
                                   value="{{ old('modelo') }}" placeholder="Ej: SBI-X200">
                            @error('modelo')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" name="bateria" min="0" max="100"
                                   ...
                                   value="{{ old('bateria') }}" placeholder="Ej: 85">
                            @error('bateria')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                            ...
                            <select name="beneficiario_id"
                                ...
                                @foreach($beneficiarios as $beneficiario)
                                    <option value="{{ $beneficiario->id }}"
                                        {{ old('beneficiario_id') == $beneficiario->id ? 'selected' : '' }}>
            ...
            <div class="card-footer d-flex justify-content-between">
                ...
                <button type="submit" class="btn btn-primary">
                    <i class="fas fa-save mr-1"></i> Guardar Bastón
                </button>
            </div>
        </form>
    </div>
